...
def get_github_stars():
    try:
        response = requests.get("https://api.github.com/repos/Bhargav-Kiku/Report-analyzer")
    ...
    st.markdown(
        ...
        <div style='{base_styles}'>
            ...
            '>
                ...
                ">
                    <a href='https://github.com/Bhargav-Kiku/Report-analyzer' 
                       target='_blank' 
                       style='
                           color: #64B5F6;
                ...
                <span style="
                    ...
                    transition: all 0.2s ease;
                ">
                    <a href='https://bhargavkikani.vercel.app' 
                       target='_blank' 
                       style='
                           color: #1976D2;
                           text-decoration: none;
